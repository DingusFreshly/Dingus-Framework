...
use crate::component::utils::{ make_drop_fn};
use crate::resource::{ResourceId, ResourceTrait};

/// A type erased heap allocation of a resources value plus its drop function.
...
impl ResourceMap {//TODO! proper error handling here instead of panicking
    ...
    /// Insert a resources, replacing any existing value of the same type.
